export const aboutMeData = {
  ...
  title: {
    FR: { name: "Matthieu", surname: "FRANQUES" },
  ...
  latestWork: {
    ...
    desc: { 
      FR: "SmartApply est une application de gestion de candidatures qui utilise l'IA pour aider les utilisateurs à suivre et optimiser leurs processus de recherche d'emploi. J'ai conçu et développé l'application en utilisant Flutter pour le frontend et Python pour les fonctionnalités d'IA, créant une expérience utilisateur fluide et intelligente.", 
      EN: "SmartApply is a application for managing job applications that leverages AI to help users track and optimize their job search processes. I designed and developed the app using Flutter for the frontend and Python for the AI features, creating a seamless and intelligent user experience." 
    }
  },
  stats: [
