...
export default function Contact() {
  return (
    <div className="max-w-2xl w-full p-8 mb-20 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-900 dark:text-white">
        Contactez-moi
      </h2>
      <p className="text-center text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto">
